...
|-------|----------|---------|
| **Email** | `soporte@beni.gob.bo` | Respuesta en 24-48 horas |
| **Teléfono** | `(591) 3-XXXXXXX` | Lunes a Viernes 8:00 - 16:00 |
| **WhatsApp** | `+591 7XX XXX XXX` | Solo mensajes, no llamadas |
...
**Mapa de Ubicación:**
El edificio central se encuentra en la zona市中心 de Trinidad, cerca de la Prefectura.
...
*   [Manual de Usuario General](/intro)
*   [FAQ - Preguntas Frecuentes](/soporte/faq)
*   [Guías por Sistema](/mamore/intro)
...
1. **Referencia:** Anota el número de ticket de referencia
2. **Email:** Responde al thread original de tu solicitud
3. **Estado:** Pregunta por el estado actual especificando la referencia
